...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_Size = "Size"; // 회사 형태
    ...
    public void addJob(List<String[]> dataList) {
        ...
        try {
            for (String[] data : dataList) {
                ...
                values.put(KEY_Size, data[12]);
                values.put(KEY_Phone, data[15]);
                values.put(KEY_Dam, data[13]);
                values.put(KEY_Rate, data[17]);
